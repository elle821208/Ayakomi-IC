...
<main>
    ...
    <section id="information">
        <div class="articles"><!--ループ文でwpの投稿を回す-->
            <?php if (have_posts()): ?><!--投稿があるときとない時で判定する※コロン構文-->
                <?php while (have_posts()): the_post(); ?><!--wp投稿がある間は投稿の情報を読み込む-->
                    <article><!--↓↓↓wpサムネイル画像-->
                        ...
                        <?php else : ?><!--※※※↓↓↓画像がない場合は下記を表示する-->
                            <figure>
                                <p class="nothing"><!--画像がないときの画像-->
                                    <img class="notihig-thumbnails" src="<?php  echo get_template_directory_uri(); ?>/img/dinosaur_spinosaurus_water.png" alt=""><!--これでimg画像を読み込む-->
                                </p>
                            </figure>
